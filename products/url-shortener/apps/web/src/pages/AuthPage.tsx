    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm space-y-4">
        ...
        <div className="space-y-2">
          <a href={`${import.meta.env.DEV ? "http://localhost:8000" : "https://auth.slyxup.online"}/api/auth/google`}
          ...
          <a href={`${import.meta.env.DEV ? "http://localhost:8000" : "https://auth.slyxup.online"}/api/auth/github`}
            className="flex items-center justify-center gap-2 w-full p-2.5 rounded-lg bg-zinc-800 text-zinc-300 hover:bg-zinc-700 transition-colors text-sm">
